...
const Data = () => {
  return (
    <div className="home_data">
      <h1 className="home_title">Minh Duc
      <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
      ...
      <h3 className="home_subtitle">Visual Designer(chicken)</h3>
      <p className="home_description">I'm creative designer (starter) based in HCM city, and i'm very passionate and dedicated to my work</p>
