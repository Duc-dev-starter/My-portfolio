    ...
    return (
        <header className="header">
            <nav className="nav container">
                <a href="index.html" className="nav_logo">Minh Duc</a>
                ...
                <div className={Toggle ? "nav_menu show-menu" : "nav_menu"}>
                    <ul className="nav_list grid">
                        ...
                        <li className="nav_item">
                            <a href="#qualification" onClick={() => setActiveNav('#qualification')} className={activeNav === "#portfolio" ? "nav_link active_link" : "nav_link"}>
