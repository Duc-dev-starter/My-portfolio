...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm("service_x1hewh5", "template_2ki8hlo", form.
    current, "vxDc14UI2jbOQBn6f")
    e.target.reset()
  };  
  return (
        ...
        <div className="contact_content">
          ...
          <div className="contact_info">
              <div className="contact_card">
                ...
                <span className="contact_card-data">leminhduck@gmail.com</span>

                <a href="mailto:leminhduck@gmail.com" className="contact_button">Write me <i className="bx bx-right-arrow-alt contact_button-icon"></i></a>
              </div>
